# -*- coding: utf-8 -*-
"""
MarketHQ Brain Research Observation Bridge V2
---------------------------------------------
...
V2:
    1) Tüm research_result knowledge item'larını yükler.
    2) metadata_json Python ile parse edilir.
    3) lifecycle_state == canonical ise aday kabul edilir.
    4) research-derived context ile observation eşleştirilir.
    5) Mevcut link varsa duplicate oluşturulmaz.
    6) Eski linkler korunur.
